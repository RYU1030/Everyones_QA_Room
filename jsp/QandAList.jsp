...
<head>
  ...
  <link rel="stylesheet" href="/css/QAndACommon.css">
...
<body>
  ...
  <main>
    <section class="top-wrapper">
      <div class="top-message-wrapper">
        <div class="top-message-inner-wrapper">
          ...
          <p class="ask-questions"><a href="./QandARegist.html">質問する</a></p>
        </div>
      </div>
    </section>
    <section class="questions-list-wrapper">
      ...
      <table class="questions-list">
        ...
        <tr>
          <td>1</td>
          <td>いつでも</td>
          <td><a href="./QandAConfirm.html" class="article-title">PHPの変数に入った値をブラウザに表示させたい</a></td>
          <td>山田太郎</td>
          <td>3/7</td>
          <td>3/7</td>
        </tr>
    ...
    <div class="page-bottom-wrapper">
      <p class="ask-questions-bottom"><a href="./QandARegist.html">質問する</a></p>
    </div>
  </main>
</body>
